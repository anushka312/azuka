...
export default function ForecastScreen({ onBack }: ForecastScreenProps) {
  ...
  const forecast = [
    { day: 'Today', date: 'Feb 4', phase: 'Luteal', icon: PetalIcon, color: '#C39588', energy: 68, workout: 'Light Yoga', workoutDuration: 45, calories: 2000, carbs: 'High', risks: ['Ligament laxity'] },
    { day: 'Wed', date: 'Feb 5', phase: 'Luteal', icon: PetalIcon, color: '#C39588', energy: 65, workout: 'Walking', workoutDuration: 30, calories: 1950, carbs: 'High', risks: [] },
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '700', color: '#1C3927' },
  subtitle: { fontSize: 14, color: '#83965F' },
  ...
  legendText: { fontSize: 10, color: '#83965F' },
  ...
  itemName: { fontSize: 16, fontWeight: '700', color: '#1C3927' },
  itemDate: { fontWeight: '400', color: '#83965F' },
  itemPhase: { fontSize: 13, color: '#83965F' },
  energyBadge: { alignItems: 'flex-end' },
  energyVal: { fontSize: 18, fontWeight: '700', color: '#1C3927' },
  energyLabel: { fontSize: 10, color: '#83965F' },
  ...
  metricVal: { fontSize: 12, fontWeight: '600', color: '#1C3927' },
  metricLabel: { fontSize: 10, color: '#83965F' },
  recommendationRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  recLabel: { fontSize: 12, color: '#83965F' },
  recValue: { fontSize: 13, fontWeight: '600', color: '#1C3927' },
  riskBanner: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(187,133,133,0.1)', padding: 8, borderRadius: 8 },
  riskText: { fontSize: 12, color: '#1C3927' },
});